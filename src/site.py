...
.fs-chips{display:flex;flex-wrap:wrap;gap:8px 22px;margin-top:8px}
.fs-chip span{display:block;font-size:11px;color:var(--muted)}
...
.fs-text{font-size:13.5px;line-height:1.8;color:var(--text-primary);
  margin:10px 0 0;max-width:47em}
