...
.sect-sum{grid-column:1;grid-row:2;font-size:12.5px;color:var(--text-secondary);
...
/* 「這一格已維持 N 期」。低調——它是脈絡不是結論，
   但它回答的是讀者看到「仍是」兩個字之後的第一個問題。 */
.v-tenure{font-size:12.5px;color:var(--muted);margin-top:11px}
