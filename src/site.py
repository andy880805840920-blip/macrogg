...
.fs-pick>summary{cursor:pointer;font-size:11.5px;color:var(--muted);
...
.fs-pick[open]>summary{color:var(--text-primary);
  border-color:var(--text-primary)}
...
@media(max-width:759px){
  ...
  /* 手機的觸控目標：按鈕本體拉到 44px 高（稽核的下限），視覺大小不變 */
  .fs-pick>summary{display:inline-flex;align-items:center;min-height:44px;
