...
/* ≤400px 時 .v-main 會降到 26px。KPI 數字、分數軸、損益兩平缺口若也留在
...
.fs-text{font-size:13.5px;line-height:1.8;color:var(--text-primary);
  margin:12px 0 0;max-width:47em;background:var(--surface-2);
