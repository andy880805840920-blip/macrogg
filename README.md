...
| 長端與債務 | 30 年期為什麼在這裡？政府與科技巨頭的發債壓力有多大？ | FRED（財政部、聯準會、BEA、ICE BofA）＋ SEC EDGAR XBRL（科技巨頭財報，自動擷取） |
...
供給壓力分數由五項加總（期限溢酬、30 年減 10 年利差、財政缺口、
科技巨頭融資缺口、投資級利差），每一項的貢獻都列出來，不做成黑箱。
